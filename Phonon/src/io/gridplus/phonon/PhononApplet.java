...
public class PhononApplet extends Applet {    //implements ExtendedLength {
   public static final short PHONON_KEY_LENGTH = 256;
    ...
    private void InitCardPairing(APDU apdu) {
        ...
        Offset += berCardSalt.BuildTLVStructure(TLV_SALT, (short) 32, salt, apduBuffer, Offset);
    ...
    private void SenderPairing(APDU apdu) {
        ...
        apduBuffer = apdu.getBuffer();
        Bertlv berCardSalt = globalBertlv;
        Offset += berCardSalt.BuildTLVStructure(TLV_SALT, (short) 32, ReceiverSalt, apduBuffer, (short) 0);

        Bertlv berCardAES = globalBertlv;
        Offset += berCardAES.BuildTLVStructure(TLV_AESIV, (short) 16, secureChannel.CardGetAESIV(), apduBuffer, Offset);
        ...
        Offset += berCardSig.BuildTLVStructure(TLV_RECEIVER_SIG, sigLen, ScratchBuffer, apduBuffer, Offset);
    ...
    private void ReceiverPairing(APDU apdu) {
        ...
        Bertlv berCardSig = globalBertlv;
        Offset += berCardSig.BuildTLVStructure(TLV_RECEIVER_SIG, sigLen, ScratchBuffer, apduBuffer);
    ...
    private void MinePhonon( APDU apdu )
    {
       ...
       if( BitsRarity > 0xff)
        ...
        if (UsingDeletedSpot == 0) {
            PhononArray[phononKeyPointer].sPhononPublicKey = new byte[65];
        }
        ...
        PhononArray[phononKeyPointer].PhononPrivateKeyLen = (short)32;
        if (UsingDeletedSpot == 0) {
            PhononArray[phononKeyPointer].sPhononPrivateKey = new byte[PhononArray[phononKeyPointer].PhononPrivateKeyLen];
        }
...
// Removed for alpha
    ...
    private void DestroyPhonon(APDU apdu) {
        ...
        short buildLen = berPhononKey.BuildTLVStructure(TLV_PRIV_KEY, PhononArray[PhononIndex].PhononPrivateKeyLen, PhononArray[PhononIndex].sPhononPrivateKey, OutgoingData, (short) 3);
        ...
        if (!DEBUG_MODE) {
            secureChannel.respond(apdu, OutgoingData, (short) (buildLen + 3), ISO7816.SW_NO_ERROR);
        }
    }
...
*/
    ...
    private void ChangeFriendlyName(APDU apdu) {
       ...
       if( (apduBuffer[ISO7816.OFFSET_LC] & 0xff) > 32 )
        {
        	secureChannel.respond(apdu, (short)0, (short)(ISO7816.SW_WRONG_LENGTH + apduBuffer[ISO7816.OFFSET_LC] & 0xff));
        	return;
        }
        ...
        friendlyNameLen = (short)(apduBuffer[ISO7816.OFFSET_LC]& 0xff);
        Util.arrayCopy(apduBuffer, ISO7816.OFFSET_CDATA, friendlyName, (short) 0, friendlyNameLen);
       secureChannel.respond(apdu, (short) 0, (short)(ISO7816.SW_NO_ERROR));
    }
